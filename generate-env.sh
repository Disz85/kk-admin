...
echo SCOUT_DRIVER=elastic
echo SCOUT_QUEUE=scout
echo ELASTIC_SCOUT_DRIVER_REFRESH_DOCUMENTS=false
...
#API
echo API_MAX_AGE=\"$API_MAX_AGE\"

#VITE
echo VITE_APP_URL=\"$VITE_APP_URL\"
echo VITE_IMAGE_URL=\"$VITE_IMAGE_URL\"
) > .env
