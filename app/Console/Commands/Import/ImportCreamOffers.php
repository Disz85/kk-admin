...
class ImportCreamOffers extends Command
{
    ...
    private function importProductOffers(string $path): void
    {
        ...
        DB::statement("
            ...
            (legacy_id, name, legacy_description, price, used, where_to_find, shipping_payment,bought_at, created_at, is_sold, approved_at, slug, legacy_image_url, legacy_product_id, legacy_created_by, legacy_bought_by)
